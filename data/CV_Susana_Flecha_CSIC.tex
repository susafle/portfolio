...
\begin{center}
    ...
    \begin{tabular}{c c c c}
        \faEnvelope\ \href{mailto:susana.flecha@csic.es}{susana.flecha@csic.es} &
        \faOrcid\ \href{https://orcid.org/0000-0001-8285-5517}{0000-0001-8285-5517} &
        \faGlobe\ \href{https://susafle.github.io/portfolio/}{Web personal} &
        \faGlobe\ \href{https://www.researchgate.net/profile/Susana-Flecha}{ResearchGate}
    \end{tabular}
\end{center}
...
\textbf{Programa Experto en Data Science + IA Generativa} -- DATAMECUM DATA MANAGEMENT, SL (En curso)
...
\raggedright
\textbf{TOTALES (2009-2025)}
\begin{itemize}[leftmargin=*,label={}]
    \item \textbf{Artículos en revistas indexadas:} 29~publicaciones
    \item \textbf{Artículos en revistas Q1:} 17~publicaciones (59\%)
    \item \textbf{Factor de Impacto promedio:} 4.2
...
\begin{minipage}[t]{0.48\textwidth}
\raggedright
\textbf{DESDE DOCTORADO (2015-2025)}
\begin{itemize}[leftmargin=*,label={}]
    \item \textbf{Artículos en revistas indexadas:} 24~publicaciones
    \item \textbf{Artículos en revistas Q1:} 15~publicaciones (63\%)
    \item \textbf{Factor de Impacto promedio:} 4.8
    \item \textbf{Primera autora:} 7~publicaciones
    \item \textbf{Autora correspondiente:} 7~publicaciones
    \item \textbf{Artículos con +40 citas:} 1~publicación
    \item \textbf{Artículos con +20 citas:} 8~publicaciones
\end{itemize}
\end{minipage}

\vspace{0.5em}
\noindent\textit{\small Datos actualizados: abril 2026.}
...
\item $\blacktriangleright$ Álvarez, M., García-Ibáñez, M.I., Lange, N., Kozyr, A., Velo, A., Tanhua, T., Civitarese, G., Cantoni, C., Belgacem, M., Schroeder, K., Acerbi, R., Coppola, L., Wagener, T., Fajar, N.M., \textbf{Flecha, S.} \textbf{(15/30)}, et al. (2025). CARIMED (CARbon, tracers, and ancillary data In the MEDiterranean Sea): A ship-based data synthesis product – overview and quality control procedures. \textit{Earth System Science Data Discussions} [preprint]. \href{https://doi.org/10.5194/essd-2025-759}{DOI: 10.5194/essd-2025-759}. \textcolor{darkgray}{\small [En revisión | IF estimado: 11.2 | Q1]}
...
\item $\blacktriangleright$ \textbf{Flecha, S.} \textbf{(1A, AC, 1/5)}, Pérez, F.F., Murata, A., Makaoui, A., Huertas, I.E. (2019). Decadal acidification in Atlantic and Mediterranean water masses exchanging at the Strait of Gibraltar. \textit{Scientific Reports}, 9(1), 15533. \href{https://doi.org/10.1038/s41598-019-52084-x}{DOI: 10.1038/s41598-019-52084-x}. \textcolor{darkgray}{\small [21 citas | IF: 3.998 | Q1]}
...
\item $\blacktriangleright$ \textbf{Flecha, S.} \textbf{(1A, AC, 1/6)}, Pérez, F.F., García-Lafuente, J., Sammartino, S., Ríos, A.F., Huertas, I.E. (2015). Trends of pH decrease in the Mediterranean Sea through high frequency observational data: Indication of ocean acidification in the basin. \textit{Scientific Reports}, 5, 16770. \href{https://doi.org/10.1038/srep16770}{DOI: 10.1038/srep16770}. \textcolor{darkgray}{\small [\textbf{48 citas - Top 10\% | IF: 5.228 | Q1}]}
...
De manera complementaria, se ha participado en \textbf{24 proyectos competitivos} (11 desde el doctorado), incluyendo \textbf{programas europeos FP6, FP7 y COST}, así como proyectos internacionales y transnacionales. En varios de ellos se han asumido \textbf{responsabilidades de coordinación científica y liderazgo de paquetes de trabajo}, particularmente en ámbitos relacionados con \textbf{gases de efecto invernadero y análisis de datos mediante inteligencia artificial} (p. ej., \textbf{BIMAR2025--GIFT4ALL} y \textbf{DICHOSO}).
...
\begin{itemize}[leftmargin=*,label={}]
    \item \textbf{Total proyectos:} 24~proyectos
    \item \textbf{Proyectos internacionales:} 7~proyectos (FP6, FP7, H2020, transnacionales)
    \item \textbf{Proyectos nacionales:} 17~proyectos
    \item \textbf{Roles de coordinación:} 6~proyectos (líder de paquete de trabajo o coordinadora científica)
\end{itemize}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.48\textwidth}
...
\begin{itemize}[leftmargin=*,label={}]
    \item \textbf{Total proyectos:} 11~proyectos
    \item \textbf{Proyectos internacionales:} 2~proyectos (FP7, parciales)
    \item \textbf{Proyectos nacionales:} 9~proyectos
    \item \textbf{Roles de coordinación:} 5~proyectos
\end{itemize}
\end{minipage}
...
\item $\blacktriangleright$ \textbf{PERSEUS – Policy-oriented marine Environmental Research in the Southern European Seas} (01/01/2012--01/04/2016).\\
    ...
    IPs: Edward P. Morris; Susana Flecha; I. Emma Huertas Cabilla; Simone Taglialatela.\\
...
\begin{itemize}[leftmargin=*]
    ...
    \item Huertas Cabilla, I. E.; \textbf{Flecha, S.}; de la Paz, M.; Navarro, G.; Pérez, F. F. (2022). 
    ...
    \item Huertas Cabilla, I. E.; Morris, E. P.; \textbf{Flecha, S.}; Figuerola Borrás, J.; Rodríguez Gálvez, S.; Costas Costas, E.; Ruíz Segura, J. (2015). 
    ...
    \item Vázquez López-Escobar, Á.; Navarro Almendros, G.; \textbf{Flecha, S.}; Bruno Mejías, M. (2009). 
...
\begin{itemize}[leftmargin=*]
    ...
    \item Ruíz Segura, J.; Huertas Cabilla, I. E.; Prieto Gálvez, L.; Navarro Almendros, G.; \textbf{Flecha, S.}; Ferrer Marco, M.; Moreno Muñoz, A.; Astorga García, D.; Taglialatela, S.; Macías, D.; García Cruz, R.; Rodríguez Gálvez, S.; Martínez Aragón, J. F. (2012). 
    ...
    \item Ruíz Segura, J.; Huertas Cabilla, I. E.; Prieto Gálvez, L.; Navarro Almendros, G.; \textbf{Flecha, S.}; Ferrer Marco, M.; Moreno Muñoz, A.; Astorga García, D.; Taglialatela, S.; Macías, D.; García Cruz, R.; Rodríguez Gálvez, S.; Martínez Aragón, J. F. (2011). 
    \textit{El estrecho como actor y receptor global: sistemas de observación en los ecosistemas marinos de Andalucía}. 
    Primer informe. Red de Observatorios de Cambio Global de Andalucía.

    \item Navarro Almendros, G.; Huertas Cabilla, I. E.; Prieto Gálvez, L.; \textbf{Flecha, S.}; Taglialatela, S.; Ruíz Segura, J. (2009). 
...
Repositorio SOCAT v2026 (Surface Ocean CO$_2$ Atlas), iniciativa internacional de referencia que compila observaciones de CO$_2$ superficial de alta calidad a escala global para la cuantificación del sumidero de carbono oceánico, el estudio de la acidificación del océano, la evaluación de modelos biogeoquímicos y el apoyo a la toma de decisiones en materia de cambio climático. SOCAT es un esfuerzo colaborativo internacional avalado por programas científicos como el \textbf{International Ocean Carbon Coordination Project (IOCCP)}, \textbf{SOLAS} y \textbf{IMBeR}.
    ...
    \item Hendriks, I.; \textbf{Flecha, S.}; Giménez Romero, A.; Tintoré, J.; Fernández Pérez, F.; Alou Font, E.; Matias, A. (2022).
    ...
    \item Huertas, I. E.; Amaya Vías, S.; \textbf{Flecha, S.}; Makaoui, A.; Pérez, F. F. (2022).
    ...
    \item Huertas, I. E.; Makaoui, A.; Pérez, F. F.; \textbf{Flecha, S.} (2020).
    ...
    \item Huertas, I. E.; García-Lafuente, J.; Sammartino, S.; \textbf{Flecha, S.} (2020).
    ...
    \item Huertas, I. E.; \textbf{Flecha, S.}; Otero, J.; Álvarez-Salgado, X. A. (2020).
    ...
    \item Huertas, I. E.; \textbf{Flecha, S.}; Makaoui, A.; Pérez, F. F. (2020).
...
\begin{itemize}[leftmargin=*]
    ...
    \textbf{Miembro de la Comisión de Divulgación del IMEDEA (CSIC-UIB)} durante el periodo \textbf{2022--2024}, participando en la planificación estratégica, coordinación de actividades públicas y representación institucional en eventos de divulgación científica.
...
Descripción: Encuentro orientado a la creación de red y al establecimiento de sinergias científicas en el ámbito de los riesgos y peligros en regiones polares, con presentaciones breves, sesiones de intercambio científico y definición de líneas de trabajo conjuntas dentro de la Conexión PolarCSIC.
    ...
    Rol:
    \begin{itemize}
        \item \textbf{Líder de sesión}: \textit{Artificial Intelligence and Machine Learning in Antarctic Science}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Bootcamp en Inteligencia Artificial}.\\
    Upgrade Hub. 190 horas. Fecha de finalización: 19/01/2026.
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Coastal Skipper Certificate of Competence}.\\
...
\begin{enumerate}[leftmargin=*]
    ...
    \textbf{[21 citas; referencia clave en intercambios Atlántico–Mediterráneo, incluida en el informe CLIVAR-Spain]}}
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        ...
        \item Inclusión de resultados en el \textbf{Intergovernmental Panel on Climate Change} (Informe Especial sobre Océanos y Criosfera, SROCC).
    \end{itemize}
